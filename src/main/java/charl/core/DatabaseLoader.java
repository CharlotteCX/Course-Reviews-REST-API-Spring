...
import charl.course.CourseRepository;
...
public class DatabaseLoader implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) throws Exception {
    Course course = new Course("Java Basics", "https://charl.com/library/java-basics");
    ...
    users.save(students);
    users.save(new User("charlochen", "Charlotte", "Chen", "12345", new String[] {"ROLE_USER", "ROLE_ADMIN"}));
